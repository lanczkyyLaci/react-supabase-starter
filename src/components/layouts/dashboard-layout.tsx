...
import { AppSidebar } from '@/components/components/app-sider/app-sidebar.tsx';
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 overflow-hidden p-2 pt-0">
          <div className="flex-1 overflow-auto rounded-xl bg-muted/60">{children}</div>
        </div>
      </SidebarInset>
    </SidebarProvider>
  );
